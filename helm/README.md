...
In het cluster worden capabilities beschikbaar gemaakt via een ApplicationSet in [platform-argocd/apps/paas-capabilities](https://github.com/InHolland-Cloud-Minor-2526/platform-argocd/tree/main/apps/paas-capabilities).
...
```bash
$ helm push capability-argocd-0.1.0.tgz oci://ghcr.io/inholland-cloud-minor-2526/paas-capabilities/
Pushed: ghcr.io/inholland-cloud-minor-2526/paas-capabilities/capability-argocd:0.1.0
